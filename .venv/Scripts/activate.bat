...
@if defined _OLD_VIRTUAL_PATH @call "C:\Users\User\PycharmProjects\wigget\.venv\Scripts\deactivate.bat"

@set "VIRTUAL_ENV=C:\Users\User\PycharmProjects\wigget\.venv"

@set "VIRTUAL_ENV_PROMPT=wigget-py3.14"
